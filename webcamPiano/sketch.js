...
// ********************************
var video;
//Step 1. changed backImg to prevImg everywhere 
var prevImg;
var diffImg;
var currImg;
var thresholdSlider;
...
function draw() {
    ...
    //Step 5. Use Resize command to scale it down
    currImg.resize(currImg.width/4,currImg.height/4);
    //Step 4. Apply blur filter and  3 as a 2nd parameter
...
// Step 2 moved keyPressed codes into draw loop
/*function keyPressed() {
    prevImg = createImage(currImg.width, currImg.height);
    prevImg.copy(currImg, 0, 0, currImg.width, currImg.height, 0, 0, currImg.width, currImg.height);
